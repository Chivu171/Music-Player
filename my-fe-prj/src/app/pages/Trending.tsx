  ...
  return (
    <div className="p-6">
        ...
        <div className="relative h-full flex items-end p-10">
          <div className="max-w-2xl">
            ...
            <p className="text-zinc-300 text-lg mb-8 font-medium">
              Discover the most played tracks from the last 7 days. Updated in real-time.
            </p>

            <button
              onClick={() => top3.length > 0 && playSong(top3[0])}
      ...
      <section className="mb-12">
        ...
        <h2 className="text-2xl font-black text-white mb-6 uppercase tracking-widest text-zinc-500 border-b border-white/5 pb-4">
          Full Chart
        </h2>
              ...
              {trendingSongs.map((song, index) => (
                ...
                >
                  ...
                  <td className="p-6 text-center">
                    <span className="text-zinc-500 font-black group-hover:hidden italic">
                      {index + 1}
                    </span>

                    <Play
                      size={16}
                      className="hidden group-hover:inline-block text-green-500 fill-green-500 mx-auto"
                    />
                  </td>
                  ...
                  <td className="p-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <p className="text-white font-black truncate tracking-tight">
                          {song.title}
                        </p>

                        <p className="text-sm text-zinc-500 font-bold truncate">
                          {song.artist}
                        </p>
                      </div>
                  ...
                  <td className="p-6 text-right text-zinc-500 font-mono text-xs tabular-nums">
                    {song.duration}
                  </td>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          ...
          {trendingArtists.map((artist: TrendingArtist) => (
            ...
            >
              ...
              <h3 className="text-white font-black truncate tracking-tighter text-lg">
                {artist.name}
              </h3>
